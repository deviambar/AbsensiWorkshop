...
<body>
    ...
    <div class="container">
          ...
          <div class="col-md-12 col-lg-8 main-content">
            ...
            <?php foreach($profile as $rowProfile){ ?> 
              <div class="col-md-12">
                ...
                { 
                  $timesystem = $row->jam_mulai_event;
                  $datesystem = $row->tanggal_event;
                  echo $datesystem;?>
                <tbody>
                  <th> <?php echo $i ; ?></th>
                  ...
                  <?php if($datesystem == $datenow){?>
                    <?php if($timenow > $timesystem){ 
                    //echo "true";?>
                ...
                <form class="form-horizontal" action="<?php echo site_url('home/check_in');?>" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="hidden" value="<?php echo $rowEvent->id_event ; ?>" name="id_event" class="form-control">
                        </div>
                        </div>
                    </div>
                    </div>
        ...
        <div class="modal fade" id="checkout<?php echo $rowEvent->id_pendaftaran;?>">
            <div class="modal-dialog">
                <form class="form-horizontal" id="formCheckout" action="<?php echo site_url('home/check_out');?>" method="post">
                    <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                    <button type="submit" id="btnCkout" name="submit" class="btn btn-primary">CheckOut</button>
                    </div>
                    </div>
                </form>
