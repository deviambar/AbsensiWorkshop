...
class Event extends CI_Controller {
    ...
    public function addEvent(){
        ...
        $jam_mulai_event = $this->input->post('jam_mulai_event');
        $jam_berakhir_event = $this->input->post('jam_berakhir_event');
        ...
        $data = array (
            ...
            'jam_mulai_event' => $jam_mulai_event,
            'jam_berakhir_event' => $jam_berakhir_event,
            'id_ruang' => $id_ruang,
            'kuota_event' => $kuota_event,
            'sisa_kuota' =>$kuota_event
            );
    ...
    public function editEvent(){
        ...
        $this->mJurusan->updateData($where, $data, 'tbl_event');
        redirect('admin/Event/index');
    }
